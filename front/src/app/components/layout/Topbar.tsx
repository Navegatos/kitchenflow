...
const notifications = [
  { id: 1, type: 'warning', text: 'Tomate por debajo del stock mínimo', time: 'hace 5 min' },
  { id: 2, type: 'warning', text: 'Mozzarella con stock crítico',         time: 'hace 12 min' },
  { id: 3, type: 'info',    text: 'Ventas Toteat sincronizadas',          time: 'hace 1 hora' },
  { id: 4, type: 'danger',  text: 'Merma alta detectada: $6.160',         time: 'hace 2 horas' },
];
      ...
      <div className="relative">
        ...
        >
          ...
          <div className="hidden md:block text-left">
            ...
            <p className="text-xs text-slate-400 leading-tight capitalize">{currentUser.role === 'admin' ? 'Administrador' : 'Operador'}</p>
          </div>
